...
const state = {
  cg_rfr_equipamentos_de_transbordo: [],
  cg_rfr_tbl_recursos: [],
  cg_rfr_recursos: [
    {
      id: 1,
  ...
  cg_rfr_variaveis_de_entrada: [
    {
      ...
      filters: [],
      dependentes: [
        "cg_rfr_carregar_equipamentos_de_transbordo",
        "cg_rfr_cf_seguros",
    ...
    },
    {
      ...
      filters: [],
      dependentes: [
        "cg_rfr_cv_energia_eletrica",
        "cg_rfr_cv_consumo_equipamentos",
        "cg_rfr_carregar_equipamentos_de_transbordo",
  ...
  cg_rfr_custos_fixos: [
    ...
    },
    {
      id: 2,
      ordem: 2,
      formula: "cg_rfr_cf_depreciacao_instalacoes",
    ...
    },
    {
      id: 3,
      ordem: 3,
      formula: "cg_rfr_cf_manutencao_instalacoes",
    ...
    },
    {
      id: 4,
      ordem: 4,
      formula: "cg_rfr_cf_depreciacao_maquinario",
    ...
    },
    {
      id: 6,
      ordem: 6,
      formula: "cg_rfr_cf_custo_oportunidade",
  ...
  cg_rfr_custos_variaveis: [
    {
      id: 1,
      formula: "cg_rfr_cv_energia_eletrica",
    ...
    {
      id: 2,
      formula: "cg_rfr_cv_consumo_equipamentos",
    ...
    {
      id: 3,
      formula: "cg_rfr_cv_manutencao_maquinario",
  ...
  cg_rfr_variaveis_de_ctrl: [
    {
      id: 1,
      ordem: 1,
      formula: "cg_rfr_ctrl_consumo_energia_eletrica",
    ...
    },
    {
      id: 2,
      ordem: 2,
      formula: "cg_rfr_ctrl_consumo_equipamentos",
    ...
    },
    {
      id: 3,
      ordem: 3,
      formula: "cg_rfr_ctrl_encargos_sociais",
    ...
    },
    {
      id: 4,
      ordem: 4,
      formula: "cg_rfr_ctrl_beneficios",
      nome: "Benefícios",
      valor: 0,
      filters: ["percent"],
      dependentes: []
    },
    {
      id: 5,
      ordem: 5,
      formula: "cg_rfr_ctrl_instalacoes",
      nome: "Instalações",
      valor: 0,
      filters: ["currency"],
      dependentes: [
        "cg_rfr_cf_depreciacao_instalacoes",
    ...
    },
    {
      id: 6,
      ordem: 6,
      formula: "cg_rfr_ctrl_periodo_depreciacao_obra_civil",
    ...
    },
    {
      id: 7,
      ordem: 7,
      formula: "cg_rfr_ctrl_fator_manutencao_obra_civil",
    ...
    },
    {
      id: 8,
      ordem: 8,
      formula: "cg_rfr_ctrl_remuneracao_do_capital",
    ...
    },
    {
      id: 11,
      ordem: 11,
      formula: "cg_rfr_ctrl_capacidade_estatica",
    ...
    },
    {
      id: 12,
      ordem: 12,
      formula: "cg_rfr_ctrl_margem_de_lucro",
    ...
    },
    {
      id: 13,
      ordem: 13,
      formula: "cg_rfr_ctrl_tarifa_limpa",
      nome: "Tarifa Limpa",
      valor: 0,
      filters: ["currency"],
      dependentes: [
    ...
    },
    {
      id: 17,
      ordem: 17,
      formula: "cg_rfr_ctrl_disponibilidade_dos_equipamentos",
    ...
    },
    {
      id: 18,
      ordem: 18,
      formula: "cg_rfr_ctrl_disponibilidade_de_vagoes_no_patio",
    ...
    },
    {
      id: 19,
      ordem: 19,
      formula: "cg_rfr_ctrl_horas_funcionamento_diario",
    ...
    },
    {
      id: 20,
      ordem: 20,
      formula: "cg_rfr_ctrl_parada_para_manutencao",
    ...
    },
    {
      id: 21,
      ordem: 21,
      formula: "cg_rfr_ctrl_fator_manutencao_do_maquinario",
...
const mutations = {
  cg_rfr_setVariavelDeEntrada(state, newItem) {
    ...
    this._vm.$set(state.cg_rfr_variaveis_de_entrada, indexOfItem, {
      id: el.id,
      ordem: el.ordem,
      formula: el.formula,
      nome: el.nome,
  ...
  cg_rfr_setCustosVariaveis(state, newItem) {
    ...
    this._vm.$set(state.cg_rfr_custos_variaveis, indexOfItem, {
      id: el.id,
      ordem: el.ordem,
      formula: el.formula,
      nome: el.nome,
  ...
  cg_rfr_setVariaveisControle(state, newItem) {
    ...
    this._vm.$set(state.cg_rfr_variaveis_de_ctrl, indexOfItem, {
      id: el.id,
      ordem: el.ordem,
      formula: el.formula,
      nome: el.nome,
  ...
  cg_rfr_setCustosFixos(state, newItem) {
    ...
    this._vm.$set(state.cg_rfr_custos_fixos, indexOfItem, {
      id: el.id,
      ordem: el.ordem,
      formula: el.formula,
      nome: el.nome,
  ...
  cg_rfr_setEquipamentosDeTransbordo(state, newItem) {
    state.cg_rfr_equipamentos_de_transbordo = newItem;
  },
...
const actions = {
  ...
  cg_rfr_ve_tempo_medio_de_armazenagem: (
    { commit, getters, dispatch },
    newValue
  ) => {
    var obj = getters.cg_rfr_getVar(
  ...
  cg_rfr_ve_movimentacao: ({ commit, getters, dispatch }, newValue) => {
    var obj = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_entrada",
      "cg_rfr_ve_movimentacao"
    );

    obj.valor = Number(newValue) || 1029547;
  ...
  cg_rfr_ve_tarifa_energia: ({ commit, getters, dispatch }, newValue) => {
    var obj = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_entrada",
      "cg_rfr_ve_tarifa_energia"
    );
  ...
  cg_rfr_ve_numero_de_funcionarios: (
    { commit, getters, dispatch },
    newValue
  ) => {
    var obj = getters.cg_rfr_getVar(
  ...
  cg_rfr_ve_salario_medio: ({ commit, getters, dispatch }, newValue) => {
    var obj = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_entrada",
      "cg_rfr_ve_salario_medio"
    );
  ...
  cg_rfr_cv_energia_eletrica: ({ commit, getters, dispatch }) => {
    var movimentacao = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_entrada",
      "cg_rfr_ve_movimentacao"
    ).valor;
    var consumo_energia_eletrica = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_consumo_energia_eletrica"
    ).valor;

    var tarifa_energia = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_entrada",
      "cg_rfr_ve_tarifa_energia"
    ).valor;
  ...
  cg_rfr_cv_consumo_equipamentos: ({ commit, getters, dispatch }) => {
    var movimentacao = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_entrada",
      "cg_rfr_ve_movimentacao"
    ).valor;

    var consumo_equipamentos = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_consumo_equipamentos"
    ).valor;
  ...
  cg_rfr_cv_manutencao_maquinario: ({ commit, getters, dispatch }) => {
    /*  var fator_de_manutencao_maquinario = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_fator_manutencao_do_maquinario"
    ).valor;

    var formula = 0
      fator_de_manutencao_maquinario * getters.cg_rfr_eqt_total_maquinario; */

    var obj = getters.cg_rfr_getVar(
      "cg_rfr_custos_variaveis",
      "cg_rfr_cv_manutencao_maquinario"
    );
  ...
  cg_rfr_ctrl_consumo_energia_eletrica: ({ commit, getters, dispatch }) => {
    var obj = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_consumo_energia_eletrica"
    );
  ...
  cg_rfr_ctrl_consumo_equipamentos: ({ commit, getters, dispatch }) => {
    var obj = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_consumo_equipamentos"
    );
  ...
  cg_rfr_ctrl_encargos_sociais: ({ commit, getters, dispatch }) => {
    var obj = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_encargos_sociais"
    );
  ...
  cg_rfr_ctrl_beneficios: ({ commit, getters, dispatch }) => {
    var obj = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_beneficios"
    );
  ...
  cg_rfr_ctrl_instalacoes: ({ commit, getters, dispatch }) => {
    var obj = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_instalacoes"
    );

    obj.valor = getters.cg_rfr_rec_total_recursos || 62775936;
  ...
  cg_rfr_ctrl_fator_manutencao_obra_civil: ({ commit, getters, dispatch }) => {
    var obj = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_fator_manutencao_obra_civil"
    );
  ...
  cg_rfr_ctrl_remuneracao_do_capital: ({ commit, getters, dispatch }) => {
    var obj = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_remuneracao_do_capital"
    );
  ...
  cg_rfr_ctrl_seguros: ({ commit, getters, dispatch }) => {
    var obj = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_seguros"
    );
  ...
  cg_rfr_ctrl_giro: ({ commit, getters, dispatch }) => {
    var movimentacao = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_entrada",
      "cg_rfr_ve_movimentacao"
    ).valor;
  ...
  cg_rfr_ctrl_capacidade_estatica: ({ commit, getters, dispatch }) => {
    var transbordo_medio_por_hora = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_entrada",
      "cg_rfr_ve_transbordo_medio_por_hora"
    ).valor;

    var disponibilidade_dos_equipamentos = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_disponibilidade_dos_equipamentos"
    ).valor;

    var disponibilidade_de_vagoes_no_patio = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_disponibilidade_de_vagoes_no_patio"
    ).valor;

    var tempo_medio_de_armazenagem = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_entrada",
      "cg_rfr_ve_tempo_medio_de_armazenagem"
    ).valor;

    var horas_funcionamento_diario = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_horas_funcionamento_diario"
    ).valor;

    var parada_para_manutencao = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_parada_para_manutencao"
    ).valor;
    ...
    obj.valor = Math.round(formula) || 34610;
  ...
  cg_rfr_ctrl_margem_de_lucro: ({ commit, getters, dispatch }) => {
    var obj = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_margem_de_lucro"
    );
    obj.valor = 0;
  ...
  cg_rfr_ctrl_tarifa_limpa: ({ commit, getters, dispatch }) => {
    var movimentacao = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_entrada",
      "cg_rfr_ve_movimentacao"
    ).valor;
    ...
    var formula =
      (getters.cg_rfr_cf_total + getters.cg_rfr_cv_total) / movimentacao;
  ...
  cg_rfr_ctrl_lucro: ({ commit, getters, dispatch }) => {
    var margem_de_lucro = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_margem_de_lucro"
    ).valor;
    var tarifa_limpa = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_tarifa_limpa"
    ).valor;
  ...
  cg_rfr_ctrl_tributos: ({ commit, getters, dispatch }) => {
    var tarifa_limpa = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_tarifa_limpa"
    ).valor;
    var lucro = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_lucro"
    ).valor;
  ...
  cg_rfr_ctrl_tarifa: ({ commit, getters, dispatch }) => {
    var tarifa_limpa = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_tarifa_limpa"
    ).valor;
    ...
    var tributos = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_tributos"
    ).valor;
  ...
  cg_rfr_ctrl_horas_funcionamento_diario: ({ commit, getters, dispatch }) => {
    var obj = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_horas_funcionamento_diario"
    );
  ...
  cg_rfr_ctrl_parada_para_manutencao: ({ commit, getters, dispatch }) => {
    var obj = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_parada_para_manutencao"
    );
  ...
  cg_rfr_cf_salarios: ({ commit, getters, dispatch }) => {
    var num_funcionarios = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_entrada",
      "cg_rfr_ve_numero_de_funcionarios"
    ).valor;

    var salario_medio = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_entrada",
      "cg_rfr_ve_salario_medio"
    ).valor;

    var encargos_sociais = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_encargos_sociais"
    ).valor;

    var beneficios = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_beneficios"
    ).valor;
  ...
  cg_rfr_cf_depreciacao_instalacoes: ({ commit, getters, dispatch }) => {
    var instalacoes = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_instalacoes"
    ).valor;

    var periodo_depreciacao_obra_civil = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_periodo_depreciacao_obra_civil"
    ).valor;
  ...
  cg_rfr_cf_manutencao_instalacoes: ({ commit, getters, dispatch }) => {
    var instalacoes = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_instalacoes"
    ).valor;

    var fator_manutencao_obra_civil = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_fator_manutencao_obra_civil"
    ).valor;
  ...
  cg_rfr_cf_depreciacao_maquinario: ({ commit, getters, dispatch }) => {
    var obj = getters.cg_rfr_getVar(
      "cg_rfr_custos_fixos",
      "cg_rfr_cf_depreciacao_maquinario"
    );

    obj.valor = getters.cg_rfr_eqt_total_depreciacao || 2032243;
  ...
  cg_rfr_cf_seguros: ({ commit, getters, dispatch }) => {
    var instalacoes = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_instalacoes"
    ).valor;

    var seguros = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_seguros"
    ).valor;

    var formula = seguros * (getters.cg_rfr_eqt_total_maquinario + instalacoes);

    var obj = getters.cg_rfr_getVar("cg_rfr_custos_fixos", "cg_rfr_cf_seguros");
  ...
  cg_rfr_cf_custo_oportunidade: ({ commit, getters, dispatch }) => {
    var instalacoes = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_instalacoes"
    ).valor;

    var remuneracao_do_capital = getters.cg_rfr_getVar(
      "cg_rfr_variaveis_de_ctrl",
      "cg_rfr_ctrl_remuneracao_do_capital"
    ).valor;
    ...
    var formula =
      ...
      (getters.cg_rfr_eqt_total_maquinario + instalacoes);
