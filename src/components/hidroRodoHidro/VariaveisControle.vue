    ...
    <v-col cols="12" sm="3">
      ...
      >
        ...
        <v-card-text class="headline font-weight-bold text-center">
          <v-divider class="pa-2"></v-divider>
          {{
            cg_hrh_getVar("cg_hrh_variaveis_de_ctrl", "cg_hrh_ctrl_lucro")
              .valor | currency
          }}
        </v-card-text>
      </v-card>
    ...
    <v-col cols="12" sm="3">
      ...
      >
        ...
        <v-card-text class="headline font-weight-bold text-center">
          <v-divider class="pa-2"></v-divider>
          {{
            cg_hrh_getVar("cg_hrh_variaveis_de_ctrl", "cg_hrh_ctrl_tributos")
              .valor | currency
          }}
        </v-card-text>
      </v-card>
      ...
      <v-card>
        ...
        <v-card-text>
          <v-data-table
            ...
            hide-default-footer
            :headers="headers"
            :items="cg_hrh_variaveis_de_ctrl"
          >
...
export default {
  ...
  computed: {
    ...mapGetters(["cg_hrh_getVar", "cg_hrh_variaveis_de_ctrl"])
  },
  filters: {
