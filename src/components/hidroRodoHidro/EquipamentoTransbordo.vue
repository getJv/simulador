      ...
      >
        <v-card-title>
          <span class="title font-weight-light text-uppercase"
            >Custo total do maquinário</span
          >
        </v-card-title>

        <v-card-text class="headline font-weight-bold text-center">
          <v-divider class="pa-2"></v-divider>
          {{ cg_hrh_eqt_total_maquinario | currency }}
        </v-card-text>
      </v-card>
    </v-col>
    <v-col cols="12" sm="4">
      ...
      >
        <v-card-title>
          <span class="title font-weight-light text-uppercase"
            >Valor total da depreciação</span
          >
        </v-card-title>

        <v-card-text class="headline font-weight-bold text-center">
          <v-divider class="pa-2"></v-divider>
          {{ cg_hrh_eqt_total_depreciacao | currency }}
        </v-card-text>
      </v-card>
    </v-col>
    <v-col cols="12" sm="10">
      <v-card>
        ...
        <v-card-text>
          <v-data-table
            ...
            hide-default-footer
            :headers="headers"
            :items="cg_hrh_equipamentos_de_transbordo"
          >
...
export default {
  ...
  computed: {
    ...mapGetters([
      ...
      "cg_hrh_eqt_total_maquinario",
      "cg_hrh_eqt_total_depreciacao"
    ])
  },
  data() {
    return {
      headers: [
        ...
        { text: "Período Depreciação", value: "periodo_depreciacao" },
