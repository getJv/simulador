    ...
    <v-col cols="12" sm="6">
      ...
      >
        ...
        <v-card-text class="headline font-weight-bold text-center">
          ...
          {{ gsa_rf_rec_total_unitario_valores | currency }}
        </v-card-text>
      </v-card>
    </v-col>
    <v-col cols="12" sm="6">
      ...
      >
        ...
        <v-card-text class="headline font-weight-bold text-center">
          <v-divider class="pa-2"></v-divider>
          {{ gsa_rf_rec_total_recursos | currency }}
        </v-card-text>
      </v-card>
    </v-col>
    <v-col cols="12" sm="10">
...
export default {
  ...
  computed: {
    ...mapGetters([
      "gsa_rf_rec_total_unitario_valores",
      "gsa_rf_rec_total_recursos",
      "gsa_rf_tbl_recursos",
    ]),
  },
  data() {
