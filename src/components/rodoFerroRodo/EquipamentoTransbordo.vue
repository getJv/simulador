    ...
    <v-col cols="12" sm="4">
      ...
      >
        ...
        <v-card-text class="headline font-weight-bold text-center">
          ...
          {{ cg_rfr_eqt_total_maquinario | currency }}
        </v-card-text>
      </v-card>
    </v-col>
    <v-col cols="12" sm="4">
      ...
      >
        ...
        <v-card-text class="headline font-weight-bold text-center">
          <v-divider class="pa-2"></v-divider>
          {{ cg_rfr_eqt_total_depreciacao | currency }}
        </v-card-text>
      </v-card>
    </v-col>
    <v-col cols="12" sm="10">
      <v-card>
        ...
        <v-card-text>
          <v-data-table
            ...
            hide-default-footer
            :headers="headers"
            :items="cg_rfr_equipamentos_de_transbordo"
          >
...
export default {
  ...
  computed: {
    ...mapGetters([
      ...
      "cg_rfr_eqt_total_maquinario",
      "cg_rfr_eqt_total_depreciacao"
    ])
  },
  data() {
    return {
