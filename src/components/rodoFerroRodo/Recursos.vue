    ...
    <v-col cols="12" sm="6">
      ...
      >
        ...
        <v-card-text class="headline font-weight-bold text-center">
          ...
          {{ cg_rfr_rec_total_unitario_valores | currency }}
        </v-card-text>
      </v-card>
    </v-col>
    <v-col cols="12" sm="6">
      ...
      >
        ...
        <v-card-text class="headline font-weight-bold text-center">
          <v-divider class="pa-2"></v-divider>
          {{ cg_rfr_rec_total_recursos | currency }}
        </v-card-text>
      </v-card>
    </v-col>
    <v-col cols="12" sm="10">
...
export default {
  ...
  computed: {
    ...mapGetters([
      "cg_rfr_rec_total_unitario_valores",
      "cg_rfr_rec_total_recursos",
      "cg_rfr_tbl_recursos"
    ])
  },
  data() {
